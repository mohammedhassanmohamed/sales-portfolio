    ...
    <>
      <div id="myfooter">
        ...
        <div className="two-icon">
          ...
          <a id="linked"
            href="https://api.whatsapp.com/send?phone=+201029632345?text=hello"
            target="_blank"
            rel="noreferrer"
          >
          <svg xmlns="http://www.w3.org/2000/svg" width="100" height="40" fill="currentColor" className="bi bi-whatsapp" viewBox="0 0 16 16">
